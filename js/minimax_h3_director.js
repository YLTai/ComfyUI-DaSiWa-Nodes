...
function install(node) {
  ...
  const render = () => {
    ...
    const hint = document.createElement("div"); hint.className = "ds-h3-small"; hint.textContent = mode() === "FL2VA" ? "FL2VA · up to 2 image slots · First → Last order" : `REF2VA · up to ${MAX.image} image, ${MAX.video} video, and ${MAX.audio} audio slots`; timeline.append(hint);
